...
WHERE created_date=DATE_SUB('${TODAY}', INTERVAL 2 DAY) AND item_cd > '900000'"

echo "Query spanner table to search those records that created_date is two days before.
